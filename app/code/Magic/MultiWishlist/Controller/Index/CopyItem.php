...
class CopyItem extends AbstractAction implements HttpPostActionInterface
{
    ...
    public function execute(): Json|Redirect
    {
        ...
        try {
            ...
            if ($this->getRequest()->isAjax()) {
                return $this->jsonResponse(true, 'Item copied successfully.');
            }
            $this->messageManager->addSuccessMessage(__('Item has been copied.'));
        } catch (\Exception) {
            return $this->jsonResponse(false, 'Could not copy item.');
        }

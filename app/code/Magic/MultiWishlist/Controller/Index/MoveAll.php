...
class MoveAll extends AbstractAction implements HttpPostActionInterface
{
    ...
    public function execute(): Json|Redirect
    {
        ...
        try {
            ...
            if ($this->getRequest()->isAjax()) {
                return $this->jsonResponse(true, 'All items moved successfully.');
            }
            $this->messageManager->addSuccessMessage(__('All items have been moved.'));
        } catch (\Exception) {
            return $this->jsonResponse(false, 'Could not move items.');
        }
